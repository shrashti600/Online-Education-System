...
<form action="#" method="post" align="center">
	...
	<option value="meeting">-select-</option>
		...
		<option value="shopping">Script tag in CSS</option>
    	<option value="rent">Types of CSS</option>
    	<option value="dinner">Change Font, image in CSS</option>
		<option value="meeting">Alignment</option>
  </select> <br><br>
