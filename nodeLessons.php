...
<form action="#" method="post" align="center">
	...
	<option value="meeting">-select-</option>
		...
		<option value="shopping">npm in Node js</option>
    	<option value="rent">Installation for Node js</option>
    	<option value="dinner">Functions in Node js</option>
		<option value="meeting">variable in Node js</option>
  </select> <br><br>
