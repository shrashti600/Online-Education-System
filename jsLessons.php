...
<form action="#" method="post" align="center">
	...
	<option value="meeting">-select-</option>
    	<option value="meeting" >Basic Introduction </option>
		<option value="shopping">JavaScript Variables</option>
    	<option value="rent">Function in JavaScript</option>
    	<option value="dinner">Comments in JavaScript</option>
		<option value="meeting">Scope of variables</option>
  </select> <br><br>
  
		
	
    	
 Add Content to Lesson<input type="text" name="desc"><br> <br>
