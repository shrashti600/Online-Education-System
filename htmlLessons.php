...
<form action="#" method="post" align="center">
	...
	<option value="meeting">-select-</option>
		...
		<option value="shopping">HTML Tags</option>
    	<option value="rent">Anchor Tag in HTML</option>
    	<option value="dinner">Comments in HTML</option>
		<option value="meeting">Add CSS to HTML code</option>
  </select> <br><br>
